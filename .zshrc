...
# cdp
alias cdp="telnet localhost 36000"
alias webkit="gulp configure -p webkit -b debug -e production"
alias firetv="gulp configure -p firetv -b debug -e production"

# gulp
alias serve="gulp serve"
alias serve-n="gulp serve --no-https"
alias dev="gulp dev"
alias glink="gulp development -d ../george"
alias rmdev="rm -rf dev_modules/@hulu"
